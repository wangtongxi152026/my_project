    ...
    <v-row justify="center" class="pm-main-sign-up">
      ...
      <v-col class="right-section" id="max-width" cols="12" md="6">
        ...
        <v-form ref="form">
          ...
          <input type="hidden" name="csrfToken" value="nbltwiCqdJ2IlrSbKGgTsLv9AvVLrfxloNqUg=" />
        </v-form>
        ...
        <v-btn class="mb-10" block color="primary" dark>
          <v-icon class="icon" left>mdi-pencil</v-icon>qq登录
        </v-btn>
      </v-col>
    </v-row>
  </v-container>
