  ...
  data: () => ({
    items: [
      ...
      },
      {
        ...
        title: '音乐',
        children: [
          { icon: 'mdi-music', title: '推荐音乐', to: '/' },
          { icon: 'mdi-music', title: '我的', to: 'userlist' },
          {
            icon: 'mdi-music',
            title: '搜索',
            to: 'search'
          },
          { icon: 'mdi-music', title: '刚刚听过', to: 'history' },
          { icon: 'mdi-music', title: '播放列表', to: 'playlist' }
        ]
      },
      {
        group: '/components',
